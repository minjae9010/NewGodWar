...
NewGodWar는 마인크래프트 신들의 전쟁 스타일 팀 기반 미니게임 플러그인입니다. 이 Wiki는 서버 운영자가 플러그인을 설치하고, 팀/신전/능력을 설정하고, 실제 경기를 진행하는 데 필요한 문서를 모아둔 공간입니다.
...
- 팀별 스폰과 다이아몬드 심장 등록
- 로비/게임 월드 분리, 월드 생성/백업, 게임 월드 자동 초기화
...
플러그인은 Java 8 바이트코드로 빌드되며, Paper/Spigot 계열 서버에서 동작하도록 설계되어 있습니다. 현재 호환성 스모크 테스트 대상은 MC 1.12.x부터 1.21.x, 그리고 26.1.1부터 26.3까지입니다.
