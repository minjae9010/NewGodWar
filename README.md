...
게시된 문서는 [GitHub Wiki](https://github.com/minjae9010/NewGodWar/wiki)에서 볼 수 있습니다. 수정할 때는 이 저장소의 `docs/wiki`를 편집하세요. Wiki에서 직접 편집한 내용은 다음 자동 동기화 때 덮어써집니다.
...
CI와 같은 JDK 21을 사용하고 `JAVA_HOME`을 해당 JDK 경로로 지정하세요. 서버 실행용 Java는 위 지원 버전에 맞춰 별도로 선택합니다. 빌드 결과는 Java 8 바이트코드입니다.
